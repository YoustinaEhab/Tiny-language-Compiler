...
public enum Token_Class
{
   ...
   // For_Loop, While_Loop, Do_Loop,
    ...
    AssignOp, PlusAssignOp, MinusAssignOp, DivideAssignOp, MultiplyAssignOp, incrementOp, decrementOp,
}
namespace Tiny_Compiler
{
    ...
    public class Scanner
    {
        ...
        public Scanner(){
            ...
            //ReservedWords.Add("for", Token_Class.For_Loop);
            //ReservedWords.Add("while", Token_Class.While_Loop);
            //ReservedWords.Add("do", Token_Class.Do_Loop);
            ...
            Arithmatic_Operator.Add("+=", Token_Class.PlusAssignOp);
            Arithmatic_Operator.Add("-=", Token_Class.MinusAssignOp);
            Arithmatic_Operator.Add("*=", Token_Class.MultiplyAssignOp);
            Arithmatic_Operator.Add("/=", Token_Class.DivideAssignOp);
            Arithmatic_Operator.Add("--", Token_Class.decrementOp);
            Arithmatic_Operator.Add("++", Token_Class.incrementOp);
